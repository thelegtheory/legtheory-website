...
export async function onRequestPost({ request, env }) {
  ...
  try {
    ...
    return json({
      error: 'Your withdrawal request could not be saved. Please try again.'
    }, 500);
  }
  ...
  const customerEmailSent = await sendEmail(env, {
    ...
    html: `
      ...
      ">
        ...
        <p style="line-height:1.7;">
          We have received your request to withdraw from your purchase.
        </p>
        ...
        <p style="line-height:1.7;">
          We will review the order details and follow up with return instructions
          and the return address where applicable.
        </p>

        <p style="line-height:1.7;">
          Please do not send the item back before receiving those instructions.
        </p>
  ...
  if (env.ORDER_NOTIFICATION_EMAIL) {
    ...
    ownerEmailSent = await sendEmail(env, {
      ...
      subject: 'New Leg Theory withdrawal request',
